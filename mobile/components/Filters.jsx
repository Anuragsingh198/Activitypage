...
export default function Filters({ styles, filters, onSearch, onSetType, onSetStatus, onClear }) {
          ...
          <View style={{ padding: 16, backgroundColor: styles.card.backgroundColor, borderTopLeftRadius: 16, borderTopRightRadius: 16, borderTopWidth: 1, borderColor: styles.card.borderColor }}>
            ...
            <View style={{ marginBottom: 10 }}>
              ...
              <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8 }}>
                {(['All','Online Class','Quiz','Assignment','Discussion']).map((t) => (
                  <Pressable key={t} onPress={() => onSetType(t)} style={[styles.chip, filters.type === t && styles.chipActive]}>
            ...
            <View>
              ...
              <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8 }}>
                {(['All','Not Started','In Progress','Completed']).map((s) => (
                  <Pressable key={s} onPress={() => onSetStatus(s)} style={[styles.chip, filters.status === s && styles.chipActive]}>
