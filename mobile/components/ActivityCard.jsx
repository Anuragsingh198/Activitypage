...
export default function ActivityCard({ styles, theme, item, onPress }) {
  ...
  const actionByStatus = item.status === 'Not Started'
    ? { label: 'Start Activity', variant: 'primary' }
    : item.status === 'In Progress'
    ? { label: 'Continue Learning', variant: 'primary' }
    : { label: 'Review & Reflect', variant: 'secondary' }
